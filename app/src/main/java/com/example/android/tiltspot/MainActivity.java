...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // An App for the tilt sensors should update its orientation with tilt
        // So no hardcoded orientation
        ...
        // get windowmanager for screen orientation
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        // Check which type of sensor triggered the event
        int sensorType = sensorEvent.sensor.getType();
        // Grab sensor data from relevant sensor
        ...
        // recalculate rotation matrix from Phone to World
        ...
        // get values from Matrix with human readable variable names
        ...
        // resetting all alphas to 0 before updating
        mSpotTop.setAlpha(0f);
        mSpotBottom.setAlpha(0f);
        mSpotLeft.setAlpha(0f);
        mSpotRight.setAlpha(0f);

        // update alpha of spots
        if (pitch > 0) {
